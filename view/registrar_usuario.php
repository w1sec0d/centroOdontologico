...
<body>
    ...
    <div class="content">
        <h1 class="title">Formulario Registro Usuarios <i class="fas fa-user"></i></h1>
        <form>
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        <label for="nombre">Nombre: </label>
                        <input type="text" class="form-control" id="nombre" placeholder="Pepito" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="apellido">Apellidos: </label>
                        <input type="text" class="form-control" id="apellidos" placeholder="Perez" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="telefono" placeholder="312-345-67-89" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="direccion">Dirección: </label>
                        <input type="text" class="form-control" id="direccion" placeholder="Carrera 12 #34-56" required>
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select id="id" class="custom-select" required>
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select id="procedimiento" class="custom-select" required>
                            <option value="ortodoncia">Ortodoncia</option>
                            <option value="extraccion">Extraccion dental</option>
            ...
            <div class="form-group">
                <label for="historia">Antecedentes clinicos: </label>
                <textarea rows="1" id="historia" class="form-control" required></textarea>
            </div>
