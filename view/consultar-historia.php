...
<div class="container-fluid w-100 h-100 form-container">
    <div class="row w-100 h-100 justify-content-center align-items-center">
        <div class="col register-form">
            <h1>Consultar Historia Clínica <i class="fas fa-clinic-medical"></i></h1>
            <form>
                <div class="form">
                    <div class="col">
                        <p>Para consultar historial clínico, seleccione su historial a editar por medio de su ID</p>
