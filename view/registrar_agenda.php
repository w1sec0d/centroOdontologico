...
<body>
    ...
    <div class="content">
        <div class="row">
            <div class="col register-form3">
                <h1 class="title">Formulario Registro Agenda Médica <i class="fas fa-calendar-week"></i></h1>
                <form>
                    <div class="form-row">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="consultorio">Numero consultorio:</label>
                                <input type="number" id="consultorio" class="form-control" required>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <img src="../img/agenda.jpg" alt="" class="register-img">
            </div>
        </div>
    </div>
