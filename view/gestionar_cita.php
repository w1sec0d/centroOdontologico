    ...
    <div class="content">
        <div class="row">
            <div class="col register-form2">
                <h1 class="title">Gestionar Cita <i class="fas fa-user-nurse"></i></h1>
                <form>
                    <h2 class="crud-title">Puedes gestionar una agenda médica en específico, buscandola por un determinado
                        atributo</h2>
                    <div class="form-row">
                        <div class="col">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="crud-buttons">
                                ...
                                <div class="btn btn-secondary" id="update2">
                                    <i class="fas fa-sync"></i>
                                </div>
                                <div class="btn btn-danger" id="delete2">
                                    <i class="fas fa-user-minus"></i>
                                </div>
                                <div class="btn btn-success" id="check2">
                                    <i class="fas fa-check"></i>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col">
                <img src="../img/citas.jpg" alt="" class="register-img">
            </div>
        </div>
    </div>
