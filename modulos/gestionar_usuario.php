    ...
    <div class="content">
        <div class="row">
            <div class="col register-form">
                <h1 class="title">Gestionar Usuarios <i class="fas fa-user"></i></h1>
                <form>
                    <h2 class="crud-title">Puedes gestionar un usuario en específico, buscandolo por un determinado atributo
                    </h2>
                    <div class="row">
                        <div class="col">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="number" name="document" class="form-control crud-input" autocomplete="off" autofocus>
                                    <div class="crud-buttons">
                                        <div class="btn btn-primary">
                                            <i class="fas fa-search"></i>
                                        </div>
                        ...
                        <div class="col">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="id" class="form-control crud-input" autocomplete="off">
                                    <div class="crud-buttons">
                                        <div class="btn btn-primary">
                                            <i class="fas fa-search"></i>
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="email" name="id" class="form-control crud-input" autocomplete="off">
                                    <div class="crud-buttons">
                                        <div class="btn btn-primary">
                                            <i class="fas fa-search"></i>
                                        </div>
            ...
            <div class="col">
                <img src="../img/users.jpg" alt="" class="register-img">
            </div>
        </div>
    </div>
